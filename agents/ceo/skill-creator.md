...
canon_source: "Model provider Codex Skill Specification (docs.anthropic.com/skills) + Model provider Plugin Specification (Codex plugin spec) — utility agent (메타-도구)"
includes:
...
- [ ] name이 파일명과 일치 (slug)
- [ ] model: sonnet (sub-agent) / opus (c-level)
